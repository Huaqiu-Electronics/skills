...
This skill provides access to the **`CanvasOpsService.CopySelected`** RPC method on the Huaqiu EDA engine. It is part of the **canvas** domain and executes against the `canvasOps` client.

| Property | Value |
| --- | --- |
| Skill ID | `canvas-copy-selected` |
| Service | `CanvasOpsService` |
| Method | `CopySelected` |
...
const skill = getSkill("canvas-copy-selected");
...
npx skills add Huaqiu-Electronics/skills --path eda/canvas/copy-selected
