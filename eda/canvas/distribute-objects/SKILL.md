---
name: canvas-distribute-objects
metadata:
  category: canvas
...
This skill provides access to the **`CanvasOpsService.DistributeObjects`** RPC method on the Huaqiu EDA engine. It is part of the **canvas** domain and executes against the `canvasOps` client.

| Property | Value |
| --- | --- |
| Skill ID | `canvas-distribute-objects` |
| Service | `CanvasOpsService` |
| Method | `DistributeObjects` |
...
const skill = getSkill("canvas-distribute-objects");
...
npx skills add Huaqiu-Electronics/skills --path eda/canvas/distribute-objects
