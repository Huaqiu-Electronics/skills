...
This skill provides access to the **`CanvasOpsService.ZoomIn`** RPC method on the Huaqiu EDA engine. It is part of the **canvas** domain and executes against the `canvasOps` client.

| Property | Value |
| --- | --- |
| Skill ID | `canvas-zoom-in` |
| Service | `CanvasOpsService` |
| Method | `ZoomIn` |
...
const skill = getSkill("canvas-zoom-in");
...
npx skills add Huaqiu-Electronics/skills --path eda/canvas/zoom-in
