...
This skill provides access to the **`CanvasOpsService.ClearAllSel`** RPC method on the Huaqiu EDA engine. It is part of the **canvas** domain and executes against the `canvasOps` client.

| Property | Value |
| --- | --- |
| Skill ID | `canvas-clear-all-sel` |
| Service | `CanvasOpsService` |
| Method | `ClearAllSel` |
...
const skill = getSkill("canvas-clear-all-sel");
...
npx skills add Huaqiu-Electronics/skills --path eda/canvas/clear-all-sel
