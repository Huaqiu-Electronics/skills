---
name: obj-place-add-bus-segment
metadata:
  category: obj-place
...
This skill provides access to the **`ObjPlaceService.AddBusSegment`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-add-bus-segment` |
| Service | `ObjPlaceService` |
| Method | `AddBusSegment` |
...
const skill = getSkill("obj-place-add-bus-segment");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/add-bus-segment
