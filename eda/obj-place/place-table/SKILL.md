...
This skill provides access to the **`ObjPlaceService.PlaceTable`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-place-table` |
| Service | `ObjPlaceService` |
| Method | `PlaceTable` |
...
const skill = getSkill("obj-place-place-table");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/place-table
