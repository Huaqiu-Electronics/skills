---
name: obj-place-place-text-from-virtual
metadata:
  category: obj-place
...
# Place Text From Virtual

Place Text From Virtual via ObjPlaceService.PlaceTextFromVirtual

## Overview

This skill provides access to the **`ObjPlaceService.PlaceTextFromVirtual`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-place-text-from-virtual` |
| Service | `ObjPlaceService` |
| Method | `PlaceTextFromVirtual` |
...
const skill = getSkill("obj-place-place-text-from-virtual");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/place-text-from-virtual
