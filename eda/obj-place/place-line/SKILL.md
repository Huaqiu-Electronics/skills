...
This skill provides access to the **`ObjPlaceService.PlaceLine`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-place-line` |
| Service | `ObjPlaceService` |
| Method | `PlaceLine` |
...
const skill = getSkill("obj-place-place-line");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/place-line
