---
name: obj-place-handle-bus-draw-click
metadata:
  category: obj-place
...
# Handle Bus Draw Click

bus

## Overview

This skill provides access to the **`ObjPlaceService.HandleBusDrawClick`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-handle-bus-draw-click` |
| Service | `ObjPlaceService` |
| Method | `HandleBusDrawClick` |
...
Returns a `HandleBusDrawClickResponse` message with the following fields:

| Name | Type | Repeated | Description |
| --- | --- | --- | --- |
| `result` | `BusDrawClickResult` | no | — |
| `objectId` | `bigint` | no | — |
...
const skill = getSkill("obj-place-handle-bus-draw-click");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/handle-bus-draw-click
