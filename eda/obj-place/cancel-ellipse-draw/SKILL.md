---
name: obj-place-cancel-ellipse-draw
metadata:
  category: obj-place
...
This skill provides access to the **`ObjPlaceService.CancelEllipseDraw`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-cancel-ellipse-draw` |
| Service | `ObjPlaceService` |
| Method | `CancelEllipseDraw` |
...
const skill = getSkill("obj-place-cancel-ellipse-draw");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/cancel-ellipse-draw
