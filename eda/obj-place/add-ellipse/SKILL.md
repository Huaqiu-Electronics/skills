...
This skill provides access to the **`ObjPlaceService.AddEllipse`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-add-ellipse` |
| Service | `ObjPlaceService` |
| Method | `AddEllipse` |
...
const skill = getSkill("obj-place-add-ellipse");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/add-ellipse
