---
name: obj-place-cancel-rect-draw
metadata:
  category: obj-place
...
This skill provides access to the **`ObjPlaceService.CancelRectDraw`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-cancel-rect-draw` |
| Service | `ObjPlaceService` |
| Method | `CancelRectDraw` |
...
const skill = getSkill("obj-place-cancel-rect-draw");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/cancel-rect-draw
