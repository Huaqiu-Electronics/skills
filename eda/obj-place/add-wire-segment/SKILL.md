---
name: obj-place-add-wire-segment
metadata:
  category: obj-place
...
This skill provides access to the **`ObjPlaceService.AddWireSegment`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-add-wire-segment` |
| Service | `ObjPlaceService` |
| Method | `AddWireSegment` |
...
const skill = getSkill("obj-place-add-wire-segment");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/add-wire-segment
