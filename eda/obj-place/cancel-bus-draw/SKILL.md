---
name: obj-place-cancel-bus-draw
metadata:
  category: obj-place
...
This skill provides access to the **`ObjPlaceService.CancelBusDraw`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-cancel-bus-draw` |
| Service | `ObjPlaceService` |
| Method | `CancelBusDraw` |
...
const skill = getSkill("obj-place-cancel-bus-draw");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/cancel-bus-draw
