---
name: obj-place-place-table-from-virtual
metadata:
  category: obj-place
...
# Place Table From Virtual

Place Table From Virtual via ObjPlaceService.PlaceTableFromVirtual

## Overview

This skill provides access to the **`ObjPlaceService.PlaceTableFromVirtual`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-place-table-from-virtual` |
| Service | `ObjPlaceService` |
| Method | `PlaceTableFromVirtual` |
...
const skill = getSkill("obj-place-place-table-from-virtual");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/place-table-from-virtual
