---
name: obj-place-handle-rect-draw-click
metadata:
  category: obj-place
...
# Handle Rect Draw Click

Handle Rect Draw Click via ObjPlaceService.HandleRectDrawClick

## Overview

This skill provides access to the **`ObjPlaceService.HandleRectDrawClick`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-handle-rect-draw-click` |
| Service | `ObjPlaceService` |
| Method | `HandleRectDrawClick` |
...
Returns a `HandleRectDrawClickResponse` message with the following fields:

| Name | Type | Repeated | Description |
| --- | --- | --- | --- |
| `result` | `RectDrawClickResult` | no | — |
| `objectId` | `bigint` | no | — |
...
const skill = getSkill("obj-place-handle-rect-draw-click");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/handle-rect-draw-click
