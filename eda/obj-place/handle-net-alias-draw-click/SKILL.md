---
name: obj-place-handle-net-alias-draw-click
metadata:
  category: obj-place
...
# Handle Net Alias Draw Click

Handle Net Alias Draw Click via ObjPlaceService.HandleNetAliasDrawClick

## Overview

This skill provides access to the **`ObjPlaceService.HandleNetAliasDrawClick`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-handle-net-alias-draw-click` |
| Service | `ObjPlaceService` |
| Method | `HandleNetAliasDrawClick` |
...
Returns a `HandleNetAliasDrawClickResponse` message with the following fields:

| Name | Type | Repeated | Description |
| --- | --- | --- | --- |
| `result` | `NetAliasDrawClickResult` | no | — |
| `objectId` | `bigint` | no | — |
...
const skill = getSkill("obj-place-handle-net-alias-draw-click");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/handle-net-alias-draw-click
