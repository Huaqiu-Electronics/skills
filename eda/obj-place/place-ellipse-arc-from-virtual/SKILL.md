---
name: obj-place-place-ellipse-arc-from-virtual
metadata:
  category: obj-place
...
# Place Ellipse Arc From Virtual

Place Ellipse Arc From Virtual via ObjPlaceService.PlaceEllipseArcFromVirtual

## Overview

This skill provides access to the **`ObjPlaceService.PlaceEllipseArcFromVirtual`** RPC method on the Huaqiu EDA engine. It is part of the **obj-place** domain and executes against the `objPlace` client.

| Property | Value |
| --- | --- |
| Skill ID | `obj-place-place-ellipse-arc-from-virtual` |
| Service | `ObjPlaceService` |
| Method | `PlaceEllipseArcFromVirtual` |
...
const skill = getSkill("obj-place-place-ellipse-arc-from-virtual");
...
npx skills add Huaqiu-Electronics/skills --path eda/obj-place/place-ellipse-arc-from-virtual
